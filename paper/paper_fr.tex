...
Li et al.~\cite{li2024persona} ont introduit un test quantitatif de stabilité
d'instruction (de persona) reposant sur des auto-conversations entre agents
personnalisés, et rapportent
...
\newblock Measuring and Controlling Instruction (In)Stability in Language Model
Dialogs.
\newblock arXiv preprint arXiv:2402.10962, 2024.

\bibitem{choi2024identity}
J.~Choi, Y.~Hong, M.~Kim et B.~Kim.
...
M.~Dabas, J.~Jeong, M.~Jin et R.~Jia.
...
Z.~Lin, X.~Hao, R.~Fu, S.~Cui, K.~Chen, C.~Li, Z.~Li et F.~Xiong.
