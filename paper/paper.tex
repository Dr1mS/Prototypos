...
Li et al.~\cite{li2024persona} introduced a quantitative benchmark for instruction
(persona) stability using self-chats between personalised chatbots, reporting significant drift
...
M.~Dabas, J.~Jeong, M.~Jin, and R.~Jia.
